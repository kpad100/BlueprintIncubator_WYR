...
export default function Hook() {
  ...
  if (directToLogin === true) return <Redirect to="/dashboard" />;
       ...
       <Grid container 
           ...
           <Grid container 
                justifyContent="center"
                 alignItems="center" 
                xs={1}>
                <Button disableElevation size="large" style={{ borderRadius:25, color: 'white' }} onClick={handleLoginClick} > 
       ...
       <Grid container 
            ...
            >
                ...
                <Grid item xs={8} style={{fontSize: 45 }}>
                    <center>
                        <h5>
                            wyr is an informative and intuitive tool to help find, choose, and organize your classes.
                        </h5>
                    </center>
                </Grid>
                <Grid>
                    <Button variant="contained" 
                        disableElevation 
                        style={{borderRadius:25, backgroundColor:"#FF7F50", color:"white", fontSize: 17,fontWeight: 'bold'}}
                        size="medium"
        ...
        <Grid container 
            ...
            >
                ...
                <Grid item xs={8} style={{fontSize: 45 }}>
                    <center>
                        <h5>
                            wyr makes sure that every review is authentic and not modified in any way.
                        </h5>
                    </center>
                </Grid>
        ...
        <Grid container 
            ...
            >
                <Grid item xs={4}>
                    <Paper elevation={0} style={{backgroundColor:'white', minHeight:"320px", }}>
        ...
        <Grid container 
            ...
            >
                ...
                <Grid item xs={6} style={{fontSize: 45 }}>
                    <center>
                        <h5>
                            write reviews based on experience to help other students choose their classes.
                        </h5>
                    </center>
                </Grid>
                <Grid item xs={1}>
        ...
        <Grid container 
            ...
            >
                ...
                <Button variant="contained" 
                    disableElevation 
                    style={{borderRadius:25, backgroundColor:"white", color:"#FF7F50", fontSize: 17,fontWeight: 'bold'}}
                    size="medium"
                    onClick={handleSignupClick}
                >
                    sign up now
