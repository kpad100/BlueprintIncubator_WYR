...
const SignupPage = ( props ) => {
    ...
    const [passwordStrenth, setPasswordstrengthCheck] = useState(true)
...
<<<<<<< HEAD
    function validateForm() {
        ...
        if(confirmPassword.length > 6 && (password.localeCompare(confirmPassword) === 0)) {
            setPassMatch(true);
            pass = pass && true;
        }
        else {
           ...
           >
               ...
               <form onSubmit={handleSubmit}>
                   <FormControl style={{minWidth:'25vw', padding:'15px'}}>
                       ...
                       {!emailfakecheck && <FormHelperText style={{color: 'red', marginBottom:'7px', alignSelf:'center'}}>
                       ...
                       {!upperlower && <FormHelperText style={{color: 'red', marginBottom:'7px', alignSelf:'center'}}>
                           Include at least one uppercase and one lower case letter
                       </FormHelperText>}
                       {!passwordStrenth && <FormHelperText style={{color: 'red', marginBottom:'7px', alignSelf:'center'}}>
